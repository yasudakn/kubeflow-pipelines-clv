...
staging_gcs_path | GCSPath | No | |The Cloud Storage path where the output of the BigQuery component is stored. Must be set to a valid GCS path or the built-in BigQuery component fails
